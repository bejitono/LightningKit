...
extension SwiftProtobuf.Message {
    ...
    func send<Response>(completion: @escaping (Result<Response, Error>) -> Void) throws where Response: SwiftProtobuf.Message {
        ...
        case is Lnrpc_OpenChannelSyncRequest: LndmobileOpenChannel(try? self.serializedData(), LndCallback(completion))
        ...
        case is Lnrpc_SendSyncRequest: LndmobileSendPayment(LndCallback(completion), nil)
